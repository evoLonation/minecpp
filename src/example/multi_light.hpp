...
int run(){
   try{
      ...
      LightScene lightScene {projectionCoord.getProjection(), viewModel.get()};
      
      glm::mat4 model { newModel() };
      float shininess = 64.0f;
      LightObjectMeta lightObject {vao, texture, specular, model, 64, shininess};
      
      lightScene.setLightObjects(&lightObject, &lightObject + 1);
